...
public class GraphicsManager {
	...
	private BufferedImage enemyFighterImg;
	private BufferedImage xWing;
	private BufferedImage redBlast;
	private BufferedImage greenBlast;
	...
	public GraphicsManager(){
		...
		try {
			...
			this.enemyFighterImg = ImageIO.read(getClass().getResource("/rbadia/voidspace/graphics/tieFighter.png"));
			this.xWing = ImageIO.read(getClass().getResource("/rbadia/voidspace/graphics/xWing.png"));
			this.redBlast = ImageIO.read(getClass().getResource("/rbadia/voidspace/graphics/redBlast.png"));
			this.greenBlast = ImageIO.read(getClass().getResource("/rbadia/voidspace/graphics/greenBlast.png"));
		} catch (Exception e) {
	...
	public void drawShip(Ship ship, Graphics2D g2d, ImageObserver observer) {
		g2d.drawImage(xWing, ship.x, ship.y, observer);
	}
	
	public void drawEnemyShip(EnemyShip enemyShip, Graphics2D g2d, ImageObserver observer) {
		g2d.drawImage(enemyFighterImg, enemyShip.x, enemyShip.y, observer);
	}
	...
	public void drawBullet(Bullet bullet, Graphics2D g2d, ImageObserver observer) {
		g2d.drawImage(redBlast, bullet.x, bullet.y, observer);
	}
	
	public void drawEnemyBullet(Bullet bullet, Graphics2D g2d, ImageObserver observer) {
		g2d.drawImage(greenBlast, bullet.x, bullet.y, observer);
	}
